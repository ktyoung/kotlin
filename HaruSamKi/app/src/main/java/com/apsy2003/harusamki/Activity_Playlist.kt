...
import com.apsy2003.harusamki.databinding.ActivityPlaylistBinding

class Activity_Playlist : BaseActivity() {
    lateinit var storagePermission: ActivityResultLauncher<String>
    val binding by lazy { ActivityPlaylistBinding.inflate(layoutInflater) }
